  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute right-0 mt-[17px] flex w-[min(260px,calc(100vw-1.5rem))] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark"
      >
        <div>
          ...
          {user?.role && (
            <span className="mt-1 inline-block rounded-full bg-brand-500/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-brand-500 dark:bg-brand-400/10 dark:text-brand-400">
              {user.role}
            </span>
          )}
        </div>
